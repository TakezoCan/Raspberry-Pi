...
class Orc(gameobjects.GameObject): # Goblin Character
    def __init__(self,name, lvl ,hp, ac, strength, att_die):
        self.class_name = "orc" #Enemy class name
        ...
        self._desc = "An ugly creature" # Dexcription of enemy
        self.dead = False
        super().__init__(name)      
